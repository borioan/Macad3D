...
public:
    ...
    /// </returns>
    static Macad::Occt::TColStd_Array2OfReal^ UnitWeights(int theNbUPoles, int theNbVPoles);
}; // class BSplSLib
...
public:
    ...
    /// </summary>
    /// <param name="in]">
    ///  theLocalU pre-computed local U parameter: (U - SpanMid) / SpanHalfLen
    /// </param>
    /// <param name="in]">
    ///  theLocalV pre-computed local V parameter: (V - SpanMid) / SpanHalfLen
    /// </param>
    /// <param name="out]">
    /// thePoint  the result of calculation (the point on the surface)
    /// </param>
    void D0Local(double theLocalU, double theLocalV, Macad::Occt::Pnt% thePoint);
    /// <summary>
    ...
    /// </param>
    /// <param name="out]">
    /// theTangentU tangent vector along U axis in the calculated point
    /// </param>
    /// <param name="out]">
    /// theTangentV tangent vector along V axis in the calculated point
    /// </param>
    void D1Local(double theLocalU, double theLocalV, Macad::Occt::Pnt% thePoint, Macad::Occt::Vec% theTangentU, Macad::Occt::Vec% theTangentV);
    /// <summary>
    ...
    /// </param>
    /// <param name="out]">
    /// theCurvatureU  curvature vector (2nd derivative on U) along U axis
    /// </param>
    /// <param name="out]">
    /// theCurvatureV  curvature vector (2nd derivative on V) along V axis
    /// </param>
    /// <param name="out]">
    /// theCurvatureUV 2nd mixed derivative on U and V
    /// </param>
    void D2Local(double theLocalU, double theLocalV, Macad::Occt::Pnt% thePoint, Macad::Occt::Vec% theTangentU, Macad::Occt::Vec% theTangentV, Macad::Occt::Vec% theCurvatureU, Macad::Occt::Vec% theCurvatureV, Macad::Occt::Vec% theCurvatureUV);
