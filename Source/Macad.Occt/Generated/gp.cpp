    ...
    : Macad::Occt::Standard_DomainError(BaseClass::InitMode::Uninitialized)
{
    ...
    _NativeInstance = new ::gp_VectorWithNullMagnitude(sz_theMessage);
...
Macad::Occt::gp_VectorWithNullMagnitude::gp_VectorWithNullMagnitude()
    : Macad::Occt::Standard_DomainError(BaseClass::InitMode::Uninitialized)
{
    _NativeInstance = new ::gp_VectorWithNullMagnitude("");
}
    ...
    : Macad::Occt::Standard_DomainError(BaseClass::InitMode::Uninitialized)
{
    ...
    _NativeInstance = new ::gp_VectorWithNullMagnitude(sz_theMessage, sz_theStackTrace);
    Marshal::FreeHGlobal((System::IntPtr)(void*)sz_theMessage);
    Marshal::FreeHGlobal((System::IntPtr)(void*)sz_theStackTrace);
}

System::String^ Macad::Occt::gp_VectorWithNullMagnitude::ExceptionType()
{
    Standard_CString _result = ((::gp_VectorWithNullMagnitude*)_NativeInstance)->ExceptionType();
