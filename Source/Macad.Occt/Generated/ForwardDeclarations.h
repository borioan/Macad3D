...
namespace Occt
{
    ...
    ref class NCollection_ForwardRangeSentinel;
    ...
    ref class GeomAdaptor_TransformedCurve;
    ref class GeomAdaptor_TransformedSurface;
    ref class TopAbs;
